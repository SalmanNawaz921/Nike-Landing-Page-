    ...
    <footer className="max-container">
      <div className="flex justify-between items-start flex-wrap max-lg:flex-col gap-20">
        <div className="flex flex-col items-start">
          ...
          <p className="mt-6 text-lg leading-7 font-monsterrat text-white-400 sm:max-w-sm">
        ...
        <div className="flex flex-1 justify-between lg:gap-10 gap-20 flex-wrap">
          {footerLinks.map((sec) => (
            <div className="" key={sec}>
              ...
              <ul>
                {sec.links.map((link) => (
                  <li className="mt-3 text-white-400 font-montserrat text-base hover:text-slate-gray cursor-pointer">
                    <a>{link.name}</a>
                  </li>
                ))}
              </ul>
